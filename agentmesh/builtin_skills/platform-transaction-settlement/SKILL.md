...
metadata:
  ...
  source: 2C-DesignWiki/jd-design-system-md-v16/product-architecture/platform-transaction/交易链路/结算/SKILL.md
  agentmesh-wiki-import: 'true'
  agentmesh-stage: during_design
  agentmesh-activation: explicit_only
  short-description: 平台交易设计部结算场域入口，按输入校验和四步方法路由结算设计任务。
disable-model-invocation: true
---
# SKILL —— 结算 场域路由

> 本文件是「结算」场域的入口路由。上层总路由见 `../../_共享底座/SKILL.md`。
