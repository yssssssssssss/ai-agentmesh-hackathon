...
metadata:
  ...
  source: 2C-DesignWiki/jd-design-system-md-v16/product-architecture/platform-transaction/交易链路/成功页/SKILL.md
  agentmesh-wiki-import: 'true'
  agentmesh-stage: during_design
  agentmesh-activation: explicit_only
  short-description: 平台交易设计部成功页场域入口，按输入校验和四步方法路由成功页设计任务。
disable-model-invocation: true
---
# SKILL —— 成功页 场域路由

> 本文件是「成功页」场域的入口路由。上层总路由见 `../../_共享底座/SKILL.md`。
