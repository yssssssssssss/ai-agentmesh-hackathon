...
metadata:
  ...
  source: 2C-DesignWiki/jd-design-system-md-v16/product-architecture/platform-transaction/交易链路/收银台/SKILL.md
  agentmesh-wiki-import: 'true'
  agentmesh-stage: during_design
  agentmesh-activation: explicit_only
  short-description: 平台交易设计部收银台场域入口，按输入校验和四步方法路由收银台设计任务。
disable-model-invocation: true
---
# SKILL —— 收银台 场域路由

> 本文件是「收银台」场域的入口路由。上层总路由见 `../../_共享底座/SKILL.md`。
