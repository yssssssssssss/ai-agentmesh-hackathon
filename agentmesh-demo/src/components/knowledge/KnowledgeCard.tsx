...
export function KnowledgeCard({ data, accent = 'default', actions }: KnowledgeCardProps) {
  return (
    <article className={`flex h-full flex-col rounded-soft border bg-surface-2 p-4 ${ACCENT[accent]}`}>
      ...
      <div className="mt-3 flex flex-wrap items-center gap-3 border-t border-white/[0.05] pt-2.5 text-[11px] text-slate-400">
