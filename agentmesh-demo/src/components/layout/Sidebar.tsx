    ...
    <aside className="flex h-full w-[260px] shrink-0 flex-col border-r border-white/[0.06] bg-base">
      ...
      <div className="border-t border-white/[0.06] p-3">
        <NavLink
          ...
          aria-label="打开数字人管理"
          className={cn(
            'group mb-2 flex min-h-12 w-full items-center gap-3 rounded-[12px] border px-3 py-2.5 text-left transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-mint-400/50',
            isDigitalHuman
        ...
        >
          ...
          <ChevronRight className={cn('h-4 w-4 shrink-0', isDigitalHuman ? 'text-mint-300' : 'text-slate-500 group-hover:text-slate-300')} />
        </NavLink>
        ...
        <button type="button" onClick={onOpenSettings} aria-label="打开账号与设置" className="mt-1 flex min-h-10 w-full items-center gap-3 rounded-[10px] px-3 py-2 text-sm text-slate-400 transition-colors hover:bg-white/[0.04] hover:text-slate-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-mint-400/50"><Settings className="h-[18px] w-[18px]" />账号与设置</button>
