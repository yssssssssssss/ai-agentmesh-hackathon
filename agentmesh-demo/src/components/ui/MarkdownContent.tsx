  ...
  return (
    <div
      className={cn(
        ...
        '[&_blockquote]:my-4 [&_blockquote]:rounded-[10px] [&_blockquote]:bg-white/[0.04] [&_blockquote]:px-4 [&_blockquote]:py-2 [&_blockquote]:text-slate-400',
        '[&_code]:rounded-[5px] [&_code]:bg-white/[0.06] [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[0.9em] [&_code]:text-mint-200',
        '[&_pre]:my-4 [&_pre]:overflow-x-auto [&_pre]:rounded-[10px] [&_pre]:bg-base [&_pre]:p-4 [&_pre]:text-xs [&_pre]:leading-6',
