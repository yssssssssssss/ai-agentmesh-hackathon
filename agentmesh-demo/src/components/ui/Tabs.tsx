...
export function Tabs({ items, value, onChange, className }: TabsProps) {
  ...
  return (
    ...
    >
      <div className="inline-flex min-w-max items-center gap-1 rounded-[12px] border border-white/[0.06] bg-surface-1 p-1">
        {items.map((item, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                'group relative inline-flex shrink-0 items-center gap-2 rounded-lg px-3.5 py-2 text-sm font-medium transition-all duration-150',
                active
