...
export function Tabs({ items, value, onChange, className }: TabsProps) {
  ...
  return (
    ...
    >
      <div className="inline-flex min-w-max items-center gap-1 rounded-soft border border-white/[0.06] bg-surface-1 p-1">
        {items.map((item, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                'group relative inline-flex shrink-0 items-center gap-2 rounded-control px-3.5 py-2 text-sm font-medium transition-[background-color,color] duration-150',
                active
