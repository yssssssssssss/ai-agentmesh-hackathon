...
export type SkillPlan = components['schemas']['SkillPlanPublicView']
export type SkillPlanNode = components['schemas']['SkillPlanNodePublicV1']
export type DeepSearchPlanNode = components['schemas']['DeepSearchPlanNodeViewV1']
export type PlanNodeView = SkillPlanNode | DeepSearchPlanNode
export type SkillPlanDetailResponse = components['schemas']['SkillPlanDetailResponse']
export type DeepSearchPlanDetailResponse = components['schemas']['DeepSearchPlanDetailResponse']
export type PlanDetailResponse = SkillPlanDetailResponse | DeepSearchPlanDetailResponse
...
export type DeepSearchPlanTransitionResponse = components['schemas']['DeepSearchPlanTransitionResponse']
export type PlanTransitionResponse = SkillPlanTransitionResponse | DeepSearchPlanTransitionResponse
