...
export type MarketActivityFeed = components['schemas']['MarketActivityFeed']
export type MarketActivityItem = components['schemas']['MarketActivityItem']
...
export type ActivityKind = MarketActivityItem['kind']
export type ActivityStatus = MarketActivityItem['status']
